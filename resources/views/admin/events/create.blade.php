                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="mt-3">
                                <small class="text-muted">
                                    <i class="fas fa-info-circle me-1"></i>
                                    Изображение будет сохранено в оригинальном размере. Для идеального отображения подготовьте картинку 313×231px.
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-success py-1 mb-0" style="font-size: 13px;">
                            ...
                            ✓ Размер: ${width}×${height}px — идеально подходит!
                        </div>
                    `;
                                            } else {
                                                sizeWarning.innerHTML = `
                        <div class="alert alert-danger py-2 mb-0" style="font-size: 13px;">
                            ...
                            <strong>Неверный размер!</strong><br>
                            Текущий размер: ${width}×${height}px<br>
                            <span class="text-danger">Рекомендуемый размер: <strong>313×231px</strong></span><br>
